            ...
            <div className="mt-10 md:mt-16 space-y-12 max-w-3xl mx-auto">
                <section>
                    ...
                    <div className="space-y-6 text-gray-200 leading-relaxed text-lg">
                        ...
                        <p>
                            I love the expressiveness and power of Clojure, but I’m equally comfortable and productive
                            in the mature Java ecosystem — Spring Boot.
                        </p>

                        <p>
                            Linux has been my daily driver for years (mostly Arch + Hyprland these days). I enjoy tweaking
                            workflows, diving deep into tooling, and understanding how systems really work under the hood.
                        </p>
                    </div>
                </section>
